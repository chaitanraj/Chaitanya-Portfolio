...
export const projects = [
    ...
    {
        title: "Buddy",
        description: "Full-stack MERN ride-sharing platform with real-time GPS tracking, a custom driver-rider matching algorithm, and a high-concurrency backend designed to support active users. Includes in-app chat between matched riders and drivers for coordination, secure ride booking flow, and persistent ride history so users can review upcoming trips and trip details anytime.",
