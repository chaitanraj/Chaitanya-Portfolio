...
export const projects = [
    ...
    {
        title: "Buddy",
        description: "Full-stack MERN ride-sharing platform with GPS accurate ride matching and a high-concurrency backend designed to support active users. Includes in-app chat between matched riders for coordination, and persistent ride history so users can review upcoming trips and trip details anytime.",
