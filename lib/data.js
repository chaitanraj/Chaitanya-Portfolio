...
export const techStack = {
    ...
    databases: [
        ...
        { name: "VectorDb", level: "Intermediate" },
...
export const projects = [
    {
        title: "FinSight-AI",
        description: "Full-stack AI finance platform with automated expense tracking, RAG-based financial assistant, monthly + category-wise spending forecasts, and anomaly detection with ~90% categorization accuracy.",
        image: "/projects/finsight.png",
        bullets: [
            "Automated expense categorization with ML (~90% accuracy)",
            "Monthly spending prediction + category-wise forecasting",
            "RAG-based finance assistant using LangChain + ChromaDB",
            "Behavior-based anomaly detection (3× fewer false alerts)",
            "Dockerized AI services for scalable deployment",
        ],

        tech: ["Next.js", "Tailwind CSS", "Node.js", "Express.js", "PostgreSQL", "LangChain", "VectorDb", "RAG", "Prisma ORM", "Python", "Flask", "Docker", "Docker Compose", "Railway", "Vercel"],
    ...
    {
        title: "Buddy",
        description: "Full-stack MERN ride-sharing platform with GPS accurate ride matching , in-app chat between matched riders for coordination and persistent ride history so users can review upcoming trips and trip details anytime.",
        image: "/projects/buddy.png",
        bullets: [
            "Real-time driver–rider matching with in-app chat for coordination",
            "Reduced ride confirmation time from ~2 minutes to under 30 seconds",
            "Persistent ride history with quick trip review and 1-click rescheduling",
            "High-concurrency backend handling 100+ simultaneous users",
            "Containerized deployment workflow using Docker Compose"
        ],
...
export const experience = [
    {
        ...
        bullets: [
           "Built end - to - end revenue management features using Node.js, TypeScript, and MySQL for 3 + platform modules.",
            "Created and maintained 10+ RESTful APIs supporting backend services and dashboard operations.",
            "Revamped the website UI across 25+ pages to improve user experience and platform presentation.",
            "Implemented monetization features that enabled new revenue - generation workflows for the platform.",
            "Collaborated with 5 + engineers on code reviews, debugging, and performance optimization"
        ],
    },
{
    company: "NyneOS Technologies Pvt. Ltd.",
        role: "Engineer Intern",
            duration: "March 2026 – Present",
                bullets: [
                    " Engineered 5+ backend services using Go (Golang) and responsive UI components using React.js.",
                    "Integrated Supabase for database management, authentication, and backend operations.",
                    "Architected scalable file storage solutions using AWS S3 for secure media management.",
                    "Collaborated with QA teams to resolve 20+ bugs and improve application stability.",
                    "Collaborated with 3+ clients’ teams to gather requirements and deliver tailored software solutions.",
                    "Utilized GitHub and CI/CD pipelines for version control and deployments."
